...
def weights_init_normal(m):
    ...
    if classname.find('Conv') != -1:
        init.normal(m.weight.data.cuda(), 0.0, 0.02)
    elif classname.find('Linear') != -1:
        init.normal(m.weight.data.cuda(), 0.0, 0.02)
    elif classname.find('BatchNorm') != -1:
        init.normal(m.weight.data.cuda(), 1.0, 0.02)
        init.constant(m.bias.data.cuda(), 0.0)
...
def weights_init_xavier(m):
    ...
    #print(classname)
    if classname.find('Conv') != -1:
        init.xavier_normal(m.weight.data.cuda(), gain=1)
    elif classname.find('Linear') != -1:
        init.xavier_normal(m.weight.data.cuda(), gain=1)
    elif classname.find('BatchNorm') != -1:
        init.normal(m.weight.data.cuda(), 1.0, 0.02)
...
def weights_init_kaiming(m):
    ...
    #print(classname)
    if classname.find('Conv') != -1:
        init.kaiming_normal_(m.weight.data.cuda(), a=0, mode='fan_in')
    elif classname.find('Linear') != -1:
        init.kaiming_normal_(m.weight.data.cuda(), a=0, mode='fan_in')
    elif classname.find('BatchNorm') != -1:
        init.normal_(m.weight.data.cuda(), 1.0, 0.02)
        init.constant_(m.bias.data.cuda(), 0.0)
...
def weights_init_orthogonal(m):
    ...
    #print(classname)
    if classname.find('Conv') != -1:
        init.orthogonal(m.weight.data.cuda(), gain=1)
    elif classname.find('Linear') != -1:
        init.orthogonal(m.weight.data.cuda(), gain=1)
    elif classname.find('BatchNorm') != -1:
        init.normal(m.weight.data.cuda(), 1.0, 0.02)
