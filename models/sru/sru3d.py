    ...
    def forward(self, x, xs, reverse=False):        
        if not self.enable_ad:
            ...
            for i in range(1, num_half_layer):
                ...
                # io.savemat('/nas_data_fibre/fugym/projects_python/SRU3D/results/sru3d/sru3dfeature'+str(i)+'.mat',{'sru3dfeature':out_np})
                reverse = not reverse
            return x
